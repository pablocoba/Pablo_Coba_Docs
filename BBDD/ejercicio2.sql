...
ALTER TABLE PROFESORES DROP COLUMN Apellido1, DROP COLUMN Apellido2;
ALTER TABLE PROFESORES DROP PRIMARY KEY;
ALTER TABLE CURSOS DROP FOREIGN KEY cursos_ibfk_1;
ALTER TABLE PROFESORES MODIFY NIF VARCHAR(10) NOT NULL;
ALTER TABLE PROFESORES CHANGE Nombre Nom_Ape VARCHAR(100) PRIMARY KEY;
